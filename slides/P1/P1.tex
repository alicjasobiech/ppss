...
\begin{frame}
    ...
    \only<2>{
        ...
        \begin{center}
            \includegraphics[width = .4\textwidth]{png/interrior.jpg}
        \end{center}
    }
    \only<3>{
        \framesubtitle{Last Graphic Novel}
        \begin{center}
            \includegraphics[width = .5\textwidth]{png/raport.jpg}
        \end{center}
    }
    \only<4>{
        \framesubtitle{Last Series}
        \begin{center}
            \includegraphics[width = .4\textwidth]{png/severance.jpg}
        \end{center}
    }
\end{frame}
